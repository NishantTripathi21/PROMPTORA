    ...
    min-h-screen'>
        <div className='text-center mb-6'>
            ...
            <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-xs text-gray-600'>
                ...
                premium AI tools. Unlock the power of AI and elevate your 
        ...
        <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
            ...
            py-3 rounded-1g hover:scale-102 active:scale-95 
            transition cursor-pointer'>Start creating now</button>
            <button className=' bg-white px-10
            py-3 rounded-1g border border-gray-300 hover:scale-102 active:scale-95 
