            ...
            <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full text-sm text-slate-500 bg-white pt-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                    <div className="sm:col-span-2 lg:col-span-1">
                        <h1 className="text-2xl font-semibold tracking-tight flex items-center gap-1" onClick={()=> Navigate('/')}>
                            <span className="text-indigo-600 font-bold">PROMPTORA</span>
                        </h1>
                        <p className="text-sm/7 mt-6">Promptora is a free and open-source UI component library with over 300+ beautifully crafted, customizable components built with Tailwind CSS.</p>
                    </div>
                ...
                <p className="py-4 text-center border-t mt-6 border-slate-200">
                    Copyright 2025 © PROMPTORA All Right Reserved.
                </p>
            </footer>
        </>
    );
