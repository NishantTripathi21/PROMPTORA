...
import React from "react";
  ...
  const GenerateImages = () => {
    ...
    const ImageStyle= [
      "Realistic", "Ghibli style", "Anime style", "Cartoon style", "Fantasy style", "Realistic style", "3D style",
      "Portrait style"
    ]
    ...
    return (
      <div>
        <div
          className="f-full overflow-y-scroll p-6 flex 
        ...
        >
          ...
          >
            ...
            <div className="my-6 flex items-center gap-2">
              <label className="relative cursor-pointer">
                <input type="checkbox" onChange={(e)=>setPusblish(e.target.checked)}
            ...
            <button
              className="w-full flex justify-center items-center gap-2
                  bg-linear-to-r from-[#00AD25] to-[#8E37EB] text-white px-4 py-2
          ...
          {/* right col */}
          <div
            className="w-full max-w-lg p-4 bg-white rounded-lg flex
