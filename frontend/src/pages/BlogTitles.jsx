...
const BlogTitles = () => {
  ...
  return (
    <div>
          <div className='f-full overflow-y-scroll p-6 flex 
          items-start flex-wrap gap-4 text-slate-700'>
            ...
            border border-gray-200'>
              ...
              text-sm rounded-md border border-gray-300' placeholder='The Future of me as Software developer....'
              required />
              ...
              <div className='mt-3 flex gap-3 flex-wrap sm:max-w-9/11'>
                {
                  blogCategories.map((item,index)=>(
                    ...
                    className={`text-xs px-4 py-1 border rounded-full cursor-pointer 
                       ...
                       : "text-gray-500 border-gray-300"}`} key={index}>{item}</span>
                  ))
                }
              </div>
              <br />
              <button className='w-full flex justify-center items-center gap-2
              bg-linear-to-r from-[#C341F6] to-[#65ADFF] text-white px-4 py-2
